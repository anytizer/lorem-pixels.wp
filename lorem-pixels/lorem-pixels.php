 ...
 * Description: API based lorem lipsum styled random text and image generator to quickly build dummy contents. Use shortcode: <code>[lorem]</code> for a random text. Text is served as micro service from <a href="http://bimal.org.np/micro-services/lorem/lorem.php">http://bimal.org.np/micro-services/lorem/lorem.php</a>. Use shortcode <code>[pixel width="200" height="100"]</code> for a random image. Images are served using <a href="http://unsplash.com/">Unsplash API</a> and/or other public image hosting services.
